  ...
  .object({
    ...
    technical_data: z
      .object({
        ...
        seller_catalog_match: z.boolean().optional(),
        seller_catalog_ambiguity: z.boolean().optional(),
        seller_catalog_reason: z.string().nullable().optional(),
        seller_catalog_source_file: z.string().nullable().optional(),
        seller_catalog_source_sheet: z.string().nullable().optional(),
        seller_catalog_source_row: z.number().nullable().optional(),
        seller_height_cm: z.number().nullable().optional(),
        seller_width_cm: z.number().nullable().optional(),
        seller_length_cm: z.number().nullable().optional(),
        seller_weight_g: z.number().nullable().optional(),
        seller_volume_cm3: z.number().nullable().optional(),
        marketplace_height_cm: z.number().nullable().optional(),
        marketplace_width_cm: z.number().nullable().optional(),
        marketplace_length_cm: z.number().nullable().optional(),
        marketplace_weight_g: z.number().nullable().optional(),
        marketplace_volume_cm3: z.number().nullable().optional(),
        marketplace_measurement_discrepancy: z.boolean().optional(),
        volume_difference_cm3: z.number().nullable().optional(),
        weight_difference_g: z.number().nullable().optional(),
      })
      .optional(),
